...
main() {
  ...
  case $scenario_number in
    1) scenario_file="scenario1_basic_concurrent_upload.js" ;;
    2) scenario_file="scenario2_gradual_user_scaling.js" ;;
    3) scenario_file="scenario3_realistic_office_pattern.js" ;;
    4) scenario_file="scenario4_burst_upload_activity.js" ;;
    5) scenario_file="scenario5_large_file_handling.js" ;;
    6) scenario_file="scenario6_mixed_operations.js" ;;
    7) scenario_file="scenario7_network_variance.js" ;;
    8) scenario_file="scenario8_maximum_capacity.js" ;;
    9) scenario_file="scenario9_mixed_file_types_longer_delays.js" ;;
    10) scenario_file="scenario10_document_upload_stress_test.js" ;;
  esac
